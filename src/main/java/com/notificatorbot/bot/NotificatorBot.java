package com.notificatorbot.bot;

import java.time.LocalDateTime;

import com.notificatorbot.config.BotConfiguration;
import com.notificatorbot.controllers.UserController;
import com.notificatorbot.model.AccessRequest;
import com.notificatorbot.model.Step;
...
public class NotificatorBot extends TelegramLongPollingBot {
    ...
    private void processStartCommand(Message message) {
        BotUtils.sendMessage(this, "Welcome to Pablo's Bot!!!", message.getChatId());
    }
